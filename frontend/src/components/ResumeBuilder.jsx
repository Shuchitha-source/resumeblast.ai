...
function ResumeBuilder({ user, onGenerateSuccess }) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // Generate text representation and pass it to parent
...
${formData.certifications}`
      ...
      setMessage('❌ Error generating resume: ' + error.message)
    } finally {
      setGenerating(false)
    }
  }
  ...
  return (
    <div className="resume-builder-container">
      <div className="resume-builder">
        ...
        <p className="builder-description">Fill in the form below and we'll generate a professional PDF resume</p>
